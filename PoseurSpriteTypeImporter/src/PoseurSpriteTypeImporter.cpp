...
*/
bool PoseurSpriteTypeImporter::loadSpriteTypes(Game *game, wstring spriteTypesListFileName)
{
...
bool PoseurSpriteTypeImporter::loadSpriteTypeInfo(string spriteTypeName)
{
...
bool PoseurSpriteTypeImporter::loadAnimationsListsInfo(const TiXmlNode *node, string spriteTypeName)
{
...
bool PoseurSpriteTypeImporter::loadAnimationStateInfo( const TiXmlNode *animationStateNode,
														map<string, vector<Pose>> *animationStates,
														string state)
{
...
bool PoseurSpriteTypeImporter::loadSpriteTypesListInfo(const char spriteTypesListFileName[])
{
...
bool PoseurSpriteTypeImporter::loadImagesListInfo(	const TiXmlNode *node, const string fullPath, const string spriteTypeName)
{
