...
#include "src\gsm\ai\EnemyBots\Bosses\ThirdBoss.h"
...
*/
ThirdBoss::ThirdBoss(	unsigned int initMin, 
...
*/
ThirdBoss::ThirdBoss(	Physics *physics,
...
Bot* ThirdBoss::clone()
{
	ThirdBoss *botClone = new ThirdBoss(	minCyclesBeforeThinking, 
...
*/
void ThirdBoss::initBot(	unsigned int initMin,
									unsigned int initMax,
									unsigned int initMaxVelocity)
{
...
*/
void ThirdBoss::pickRandomCyclesInRange()
{
...
*/
void ThirdBoss::pickRandomVelocity(Physics *physics)
{
...
*/
void ThirdBoss::think(Game *game)
{
