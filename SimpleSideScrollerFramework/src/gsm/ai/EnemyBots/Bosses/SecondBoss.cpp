...
#include "src\gsm\ai\EnemyBots\Bosses\SecondBoss.h"
...
*/
SecondBoss::SecondBoss(	unsigned int initMin, 
...
*/
SecondBoss::SecondBoss(	Physics *physics,
...
*/
Bot* SecondBoss::clone()
{
	SecondBoss *botClone = new SecondBoss(	minCyclesBeforeThinking, 
...
*/
void SecondBoss::initBot(	unsigned int initMin,
									unsigned int initMax,
									unsigned int initMaxVelocity)
{
...
*/
void SecondBoss::pickRandomCyclesInRange()
{
...
*/
void SecondBoss::pickRandomVelocity(Physics *physics)
{
...
*/
void SecondBoss::think(Game *game)
{
